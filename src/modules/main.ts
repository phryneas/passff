...
export class log {
  static generateArguments(args: IArguments) {
   ...
   static debug = logPrototype.bind(console.debug);
   static info  = logPrototype.bind(console.info);
   static warn  = logPrototype.bind(console.warn);
   static error = logPrototype.bind(console.error);
}
...
export class PassFF {
  ...
  private static menu_state : MenuState = new MenuState();
  ...
  private static bg_handle(request: {action:string, params?: any[]}, sender: any, sendResponse: Function) {
